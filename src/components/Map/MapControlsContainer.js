...
import stylesExtended from "components/Map/MapControlsContainer.scss";
...
export class MapControlsContainer extends MapControlsContainerCore {
    ...
    render() {
        ...
        let positionedContainerClasses = MiscUtil.generateStringFromSet({
            [stylesExtended.mapControlsContainer]: true,
        ...
        return (
            ...
            >
                <div className={positionedContainerClasses}>
